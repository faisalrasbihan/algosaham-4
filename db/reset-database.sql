...
CREATE TABLE users (
  ...
  analyze_limit INTEGER NOT NULL DEFAULT 3,
  analyze_used_today INTEGER DEFAULT 0,
  analyze_last_reset TIMESTAMPTZ DEFAULT NOW(),
  screening_limit INTEGER NOT NULL DEFAULT 3,
  screening_used_today INTEGER DEFAULT 0,
  screening_last_reset TIMESTAMPTZ DEFAULT NOW(),
  backtest_limit INTEGER NOT NULL DEFAULT 3,
  backtest_used_today INTEGER DEFAULT 0,
  backtest_last_reset TIMESTAMPTZ DEFAULT NOW(),
  saved_strategies_limit INTEGER NOT NULL DEFAULT 1,
  saved_strategies_count INTEGER DEFAULT 0,
  subscriptions_limit INTEGER NOT NULL DEFAULT 1,
  subscriptions_count INTEGER DEFAULT 0,
  ai_chat_limit INTEGER DEFAULT 5,
  ai_chat_used_today INTEGER DEFAULT 0,
  ai_chat_last_reset TIMESTAMPTZ DEFAULT NOW(),
